...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_5x6(
        ...
        _______ , _______, _______, _______, _______, _______,                        _______, KC_7   , KC_8   , KC_9   , KC_MPRV, KC_VOLU,
        _______ , _______, _______, _______, _______, KC_PSCR,                        _______, KC_4   , KC_5   , KC_6   , KC_MPLY, KC_MUTE,
        _______ , _______, _______, _______, _______, _______,                        _______, KC_1   , KC_2   , KC_3   , KC_MNXT, KC_VOLD,
